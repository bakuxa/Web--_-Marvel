	...
	<main>
		...
		<div class="container">
			...
			<p><a href="../actors/ChrisHemsworth.php"><img class="img-menu" src="../img/КрисХемс.jpg" alt="Изображение"></a></p>
				...
				<p><a href="../actors/MarkRuffalo.php"><img class="img-menu img-menu-active" src="../img/МаркРуффало.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 8"; 
			...
			<div class="image-block">
				<img src="../img/ElizabethOlsen.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/Wanda.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
