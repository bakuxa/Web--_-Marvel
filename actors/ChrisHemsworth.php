	...
	<main>
		...
		<div class="container">
			...
			<div class="sidebar prokrutka-menu-left" id="menu">	
				...
				<p><a href="../actors/ChrisHemsworth.php"><img class="img-menu img-menu-active" src="../img/КрисХемс.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 2"; 
			...
			<div class="image-block">
				<img src="../img/ChrisHemsworth.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/Top.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
