	...
	<main>
		...
		<div class="container">
			...
			<div class="sidebar prokrutka-menu-left" id="menu">	
				...
				<p><a href="../actors/TomHiddleston.php"><img class="img-menu img-menu-active" src="../img/ТомХиддлстон.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 6"; 
			...
			<div class="image-block">
				<img src="../img/TomHiddleston.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/Loki.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
