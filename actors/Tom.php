	...
	<main>
		...
		<div class="container">
			<div class="sidebar prokrutka-menu-left" id="menu">	
				...
				<p><a href="../actors/Tom.php"><img class="img-menu img-menu-active" src="../img/ТомХолланд.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 3"; 
			...
			<div class="image-block">
				<img src="../img/TomHolland.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/SpiderMan.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
