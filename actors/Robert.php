...
<html>
	...
	<main>
		...
		<div class="container">
			...
			<p><a href="../actors/Robert.php"><img class="img-menu img-menu-active" src="../img/Robert-menu.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 1"; 
			...
			<div class="image-block">
				<img src="../img/Robert1.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/IronMan.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
