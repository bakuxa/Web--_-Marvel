	...
	<main>
		...
		<div class="container">
			...
			<p><a href="../actors/ChrisHemsworth.php"><img class="img-menu" src="../img/КрисХемс.jpg" alt="Изображение"></a></p>
				...
				<p><a href="../actors/BrieLarson.php"><img class="img-menu img-menu-active" src="../img/БриЛарсон.jpg" alt="Изображение"></a></p>
			</div>

			<div class="content">
			<?php
				$connection = mysqli_connect('localhost', 'root', '', 'website');
				$sql = "SELECT name, info1 FROM website WHERE id = 11"; 
			...
			<div class="image-block">
				<img src="../img/BrieLarson.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/CaptainMarvel.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
