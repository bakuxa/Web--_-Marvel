	...
	<main>
		...
		<div class="container">
			...
			<div class="sidebar prokrutka-menu-left" id="menu">	
				...
				<p><a href="../actors/ChrisEvans.php"><img class="img-menu img-menu-active" src="../img/КрисЭванс.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 5"; 
			...
			<div class="image-block">
				<img src="../img/ChrisEvans.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/America.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
