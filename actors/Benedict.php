	...
	<main>
		...
		<div class="container">
			...
			<p><a href="../actors/Robert.php"><img class="img-menu" src="../img/Robert-menu.jpg" alt="Изображение"></a></p>
				...
				<p><a href="../actors/Benedict.php"><img class="img-menu img-menu-active" src="../img/Бенедикт.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 7"; 
			...
			<div class="image-block">
				<img src="../img/BenedictCumberbatch.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/Strange.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
