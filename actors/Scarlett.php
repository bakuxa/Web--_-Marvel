	...
	<main>
		...
		<div class="container">
			...
			<div class="sidebar prokrutka-menu-left" id="menu">	
				<p><a href="../actors/Robert.php"><img class="img-menu" src="../img/Robert-menu.jpg" alt="Изображение"></a></p>
				...
				<p><a href="../actors/Scarlett.php"><img class="img-menu img-menu-active" src="../img/Скарлет.jpg" alt="Изображение"></a></p>
				...
				<p><a href="../actors/PaulRudd.php"><img class="img-menu" src="../img/ПолРадд.jpg" alt="Изображение"></a></p>
			...
			<?php
				...
				$sql = "SELECT name, info1 FROM website WHERE id = 4"; 
			...
			<div class="image-block">
				<img src="../img/ScarlettJohansson.png" alt="Изображение">
			</div>

			<div class="right-arrow">
				<a href="../heroes/BlackWidow.php"><img src="../img/next.png" alt="Изображение"></a>
			</div>
