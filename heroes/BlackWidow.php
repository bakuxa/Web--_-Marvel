 ...
 <body>
	...
	<div class="container">
		...
		<?php
				...
				$sql = "SELECT name, info FROM heroes WHERE id = 4"; 
		...
		<div class="image-block">
			<img src="../img/BlackWidow.png" alt="Изображение">
		</div>

		<div class="left-arrow">
			<a href="../actors/Scarlett.php"><img src="../img/back.png" alt="Изображение"></a>
		</div>
