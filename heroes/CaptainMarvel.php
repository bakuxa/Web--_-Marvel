 ...
 <body>
	...
	<div class="container">
		...
		<?php
				...
				$sql = "SELECT name, info FROM heroes WHERE id = 5"; 
		...
		<div class="image-block">
			<img src="../img/CaptainMarvel.png" alt="Изображение">
		</div>

		<div class="left-arrow">
			<a href="../actors/BrieLarson.php"><img src="../img/back.png" alt="Изображение"></a>
		</div>
