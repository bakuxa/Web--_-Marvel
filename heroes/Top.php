 ...
 <body>
	...
	<div class="container">
		...
		<?php
				...
				$sql = "SELECT name, info FROM heroes WHERE id = 10"; 
		...
		<div class="image-block">
			<img src="../img/Tor-left.png" alt="Изображение">
		</div>

		<div class="left-arrow">
			<a href="../actors/ChrisHemsworth.php"><img src="../img/back.png" alt="Изображение"></a>
		</div>
